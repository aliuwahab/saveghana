...
$NIMBUS_OPTIONS_ARR[] = array( "tab" => "membership",
    "html" => "
        <div id='membership_tab'>
            ...
            <a class='membership_button' style='float:right; margin:15px 0 0 0' href='http://www.nimbusthemes.com/join/?utm_source=wp_opulus&utm_medium=theme&utm_content=panel_membership_tag&utm_campaign=wp_opulus'>" . __('Join Today!', 'nimbus') . "</a>
            <div class='clear'></div>
            <h2>" . __('Unlimited downloads of all Nimbus Themes! Plus...', 'nimbus') . "</h2>
            <div class='clear5'></div>
            <ul>
                <li>
                    <h3>" . __('Unlimited Support on the Nimbus Forums', 'nimbus') . "</h3>
    ...
    <a href='http://demo.nimbusthemes.com/opulus/home/alt-home-3/' target='_blank'>" . __('Frontpage 4', 'nimbus') . "</a> | <a href='http://demo.nimbusthemes.com/opulus/home/alt-home-4/' target='_blank'>" . __('Frontpage 5', 'nimbus') . "</a> | <a href='http://demo.nimbusthemes.com/opulus/home/alt-home-5/' target='_blank'>" . __('Frontpage 6', 'nimbus') . "</a> | <a href='http://demo.nimbusthemes.com/opulus/home/alt-home-6/' target='_blank'>" . __('Frontpage 7', 'nimbus') . "</a></p>
                ...
                <li><h3>" . __('Portfolio Pages', 'nimbus') . "</h3>
...
$NIMBUS_OPTIONS_ARR[] = array("name" => __('Banner Options', 'nimbus'),
    ...
    "info" => "<p>" . __('You have the option of creating a variety of layouts for the banner area on your home page. Here\'s a breakdown of the options:', 'nimbus') . "</p>
                                    <ul>
                                        ...
                                        <li><strong>" . __('(2) Banner Content, Image with Border:</strong> Banner content is located on the left. Static image is aligned top-right with a border.', 'nimbus') . "<br /><img src='" . get_template_directory_uri() . "/nimbus/images/banner_2.gif' style='margin:10px 0 10px 80px; border: 1px solid #B6B6B6;' alt='banner example'  /></li> 
                                        <li><strong>" . __('(3) Full Width Static Image With Border', 'nimbus') . "</strong><br /><img src='" . get_template_directory_uri() . "/nimbus/images/banner_3.gif' style='margin:10px 0 10px 80px; border: 1px solid #B6B6B6;' alt='banner example' /></li> 
                                        ...
                                        <li><strong>" . __('(5) Full Width Slideshow:</strong> Full sized slideshow spans across the entire banner area.', 'nimbus') . "<br /><img src='" . get_template_directory_uri() . "/nimbus/images/banner_5.gif' style='margin:10px 0 10px 80px; border: 1px solid #B6B6B6;' alt='banner example' /></li> 
                                        <li><strong>" . __('(6) Banner Content with Slideshow:</strong> Banner content is located on the left. Slideshow on the right side.', 'nimbus') . "<br /><img src='" . get_template_directory_uri() . "/nimbus/images/banner_6.gif' style='margin:10px 0 10px 80px; border: 1px solid #B6B6B6;' alt='banner example'  /></li> 
                                        <li><strong>" . __('(7) Full Width Banner Content:</strong> Banner content spans full width.', 'nimbus') . "<br /><img src='" . get_template_directory_uri() . "/nimbus/images/banner_7.gif' style='margin:10px 0 10px 80px; border: 1px solid #B6B6B6;' alt='banner example' /></li> 
                                    </ul>",
