...
function omega_theme_admin_archives() {
	...
	add_filter( "sanitize_option_{$prefix}_theme_settings", 'omega_theme_validate_archives' );
...
?>
	...
	<div id="omega_more_link_scroll" <?php if ( 'full' != hybrid_get_setting( 'content_archive' )) echo 'class="hidden"';?>>
	<p>
		<label for="<?php echo hybrid_settings_field_id( 'more_link_scroll' ); ?>"><input type="checkbox" name="<?php echo hybrid_settings_field_name( 'more_link_scroll' ); ?>" id="<?php echo hybrid_settings_field_id( 'more_link_scroll' ); ?>" value="1" <?php checked( hybrid_get_setting( 'more_link_scroll' ) ); ?> />
