            ...
            <div class="carousel-inner">
                <div class="item active">
                   <div class="carousel-image">
                      <img width="1200" height="500" src="<?php echo TC_BASE_URL ?>inc/img/saveghana3.JPG" class="slide wp-post-image" alt="<?php _e( 'Customizr is a clean responsive theme' , 'customizr' ) ?>">
                    </div>
                    <div class="carousel-caption">
                        <h1><?php _e( 'Lives Got to be Better' , 'customizr' ) ?></h1>
                          <p class="lead"><?php _e( 'Every Human has a right to a better life, and that\'s what Save Ghana stands for!' , 'customizr' ) ?></p>
                         <a class="btn btn-large btn-primary" href="http://localhost/wordpress/mission-vision"><?php _e( 'Find out why we exist' , 'customizr' ) ?></a>
                    </div>
                </div>
              <div class="item">
                 <div class="carousel-image">
                      <img width="1200" height="500" src="<?php echo TC_BASE_URL ?>inc/img/saveghana1.JPG" class="slide wp-post-image" alt="<?php _e( 'Style your WordPress site live!' , 'customizr' ) ?>">
                  </div>
                  <div class="carousel-caption">
                      <h1><?php _e( 'Save Ghana has touch a lot lives!' , 'customizr' ) ?></h1>
                        <p class="lead"><?php _e( 'We work to change the life of the poor, the needy and the vulnerable. All our projects, both past and present attest to that...' , 'customizr' ) ?></p>
                       <a class="btn btn-large btn-primary" href="http://localhost/wordpress/what-we-do/current-projects"><?php _e( 'Find out more!' , 'customizr' ) ?></a>
                    </div>
                </div>
              <div class="item">
                 <div class="carousel-image">
                  <img width="1200" height="500" src="<?php echo TC_BASE_URL ?>inc/img/saveghana2.JPG" class="slide wp-post-image" alt="<?php _e( 'Create beautiful sliders' , 'customizr' ) ?>">
                </div>
                <div class="carousel-caption">
                  <h1><?php _e( 'Help Our Course' , 'customizr' ) ?></h1>
                      <p class="lead"><?php _e( 'A lot of lives deserves better. Anybody can help to make thousands of lives better. Save-Ghana is working and will continue to work to put smiles on the faces of the poor. You can also help to make it happen.' , 'customizr' ) ?></p>
                     <a class="btn btn-large btn-primary" href="http://localhost/wordpress/how-to-support/ ‎"><?php _e( 'Find out how' , 'customizr' ) ?></a>
                </div>
              </div>
            </div><!-- /.carousel-inner -->
