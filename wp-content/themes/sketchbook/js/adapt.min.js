/*Just like the 960 Grid System itself, Adapt.js is licensed under GPL and MIT. 
 * That means it is free, as in speech. If you want to use it in a product that is already licensed under the GPL, you can.
 * Or, if you want to use it in a commercial product, you can choose the MIT license instead. No strings attached.
 */  
