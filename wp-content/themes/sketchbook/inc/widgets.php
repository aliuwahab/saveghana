...
/*********************/
/***********FLICKR**********/
     class sketchbook_flickr_widget extends WP_Widget {
     function sketchbook_flickr_widget() {
     $widget_ops = array( 'description' => __('Flickr gallery','sketchbook') );
     $this->WP_Widget('', 'Sketchbook - Flickr', $widget_ops);
...
?>
<p>
	<label for="<?php echo $this -> get_field_id('title');?>"> <?php _e('Title:', 'sketchbook');?><input class="widefat" id="<?php echo $this -> get_field_id('title');?>" name="<?php echo $this -> get_field_name('title');?>" type="text" value="<?php echo esc_attr($title);?>" /></label>
</p>
<p>
	<label for="<?php echo $this -> get_field_id('idflickr');?>">
				<?php	printf(__('"Flickr"- ID. <a href="%s" target="_blank">idgettr.com</a>', 'sketchbook'), sprintf(esc_url(__('http://idgettr.com/', 'sketchbook'))));?>
...
<p>
	<label for="<?php echo $this -> get_field_id('numberflickr');?>"><?php _e('Number of photo to display:', 'sketchbook');?></label>
...
register_widget('sketchbook_flickr_widget');
/***********TWITTER********/
class sketchbook_twitter_widget extends WP_Widget {
function sketchbook_twitter_widget() {
$widget_ops = array('classname' => 'twitter_bg', 'description' =>
__('A widget to enable people to follow you on Twitter','sketchbook'));
$this->WP_Widget('', 'Sketchbook - Twitter', $widget_ops);
...
function form($instance) {
$instance = wp_parse_args( (array) $instance, array( 'title' => 'Twitter', 'twitter' => '', 'numbertwitter' => '3', 'follow' => __('follow me on Twitter','sketchbook') ) );
$title = strip_tags($instance['title']);
...
?>
<p>
	<label for="<?php echo $this -> get_field_id('title');?>"> <?php _e('Title:', 'sketchbook');?>
		<input class="widefat" id="<?php echo $this -> get_field_id('title');?>" name="<?php echo $this -> get_field_name('title');?>" type="text" value="<?php echo esc_attr($title);?>" /></label>
</p>
<p>
	<label for="<?php echo $this -> get_field_id('twitter');?>"><?php _e('User:', 'sketchbook');?>
		<input class="widefat" id="<?php echo $this -> get_field_id('twitter');?>" name="<?php echo $this -> get_field_name('twitter');?>" type="text" value="<?php echo esc_attr($twitter);?>" />
	</label>
</p>
<p>
	<label for="<?php echo $this -> get_field_id('follow');?>"><?php _e('Text:', 'sketchbook');?>
...
<p>
	<label for="<?php echo $this -> get_field_id('numbertwitter');?>"><?php _e('Number of Tweets to display:', 'sketchbook');?></label>
...
register_widget('sketchbook_twitter_widget');
/***********SOCIAL**********/
class sketchbook_social_widget extends WP_Widget {
function sketchbook_social_widget() {
$widget_ops = array( 'description' => __('User profiles', 'sketchbook') );
$this->WP_Widget('sketchbook_social_widget', __('Sketchbook - Social Media Profiles', 'sketchbook'), $widget_ops);
}
...
echo '<ul>';
if (!empty($feed)) {echo '<li><a title="'.__('Syndicate this site using RSS','sketchbook').'" href="'.esc_url($feed).'">'.__('<abbr title="Really Simple Syndication">RSS</abbr>','sketchbook').'</a></li>';}
if (!empty($facebook)) {  echo '<li class="fb"><a title="'.__('Facebook profile','sketchbook').'" href="'.esc_url($facebook).'">Facebook profile</a></li>'; }
if (!empty($google)) {  echo '<li class="go"><a title="'.__('Google Plus profile','sketchbook').'" href="'.esc_url($google).'">Google Plus profile</a></li>'; }
if (!empty($twitter)) {  echo '<li class="tw"><a title="'.__('Twitter profile','sketchbook').'" href="'.esc_url($twitter).'">Twitter profile</a></li>';  }
if (!empty($tube)) {  echo '<li class="tb"><a title="'.__('YouTube profile','sketchbook').'" href="'.esc_url($tube).'">YouTube profile</a></li>';  }
if (!empty($lastfm)) {  echo '<li class="fm"><a title="'.__('LastFm profile','sketchbook').'" href="'.esc_url($lastfm).'" >Last FM profile</a></li>';  }
if (!empty($deviant)) {  echo '<li class="dv"><a title="'.__('DevianArt profile','sketchbook').'" href="'.esc_url($deviant).'" >DeviantArt profile</a></li>';  }
if (!empty($behance)) {  echo '<li class="be"><a title="'.__('Behance profile','sketchbook').'" href="'.esc_url($behance).'" >Behance profile</a></li>';  }
if (!empty($linkedin)) {  echo '<li class="li"><a title="'.__('Linkedin profile','sketchbook').'" href="'.esc_url($dribbble).'" >Linkedin profile</a></li>';  }
if (!empty($dribbble)) {  echo '<li class="dr"><a title="'.__('Dribbble profile','sketchbook').'" href="'.esc_url($dribbble).'" >Dribbble profile</a></li>';  }
...
'facebook' => '','twitter' => '','google' => '', 'tube' => '', 'lastfm' => '','linkedin' => '', 'behance' =>'','dribbble' =>'' ) );
...
e.g. http://feedburner.com/userid', 'sketchbook');?>
...
<p>
	<label for="<?php echo $this -> get_field_id('facebook');?>"> <?php _e('Enter <strong>Facebook</strong>  account url', 'sketchbook');?>
...
<p>
	<label for="<?php echo $this -> get_field_id('google');?>"> <?php _e('Enter <strong>Google Plus</strong>  account url', 'sketchbook');?>
...
<p>
	<label for="<?php echo $this -> get_field_id('twitter');?>"><?php _e('Enter <strong>Twitter</strong>  account url', 'sketchbook');?>
		<input class="widefat" id="<?php echo $this -> get_field_id('twitter');?>" name="<?php echo $this -> get_field_name('twitter');?>" type="text" value="<?php echo esc_attr($twitter);?>" />
	</label>
</p>
<p>
	<label for="<?php echo $this -> get_field_id('tube');?>"><?php _e('Enter <strong>YouTube</strong>  account url', 'sketchbook');?>
...
<p>
	<label for="<?php echo $this -> get_field_id('lastfm');?>"><?php _e('Enter <strong>LastFM</strong>  account url', 'sketchbook');?>
...
<p>
	<label for="<?php echo $this -> get_field_id('deviant');?>"><?php _e('Enter <strong>DeviantArt</strong>  account url', 'sketchbook');?>
...
<p>
	<label for="<?php echo $this -> get_field_id('behance');?>"><?php _e('Enter <strong>Behance</strong>  account url', 'sketchbook');?>
...
<p>
	<label for="<?php echo $this -> get_field_id('linkedin');?>"><?php _e('Enter <strong>Linkedin</strong>  account url', 'sketchbook');?>
		<input class="widefat" id="<?php echo $this -> get_field_id('linkedin');?>" name="<?php echo $this -> get_field_name('linkedin');?>" type="text" value="<?php echo esc_attr($linkedin);?>" />
	</label>
</p>
<p>
	<label for="<?php echo $this -> get_field_id('dribbble');?>"><?php _e('Enter <strong>Dribbble</strong>  account url', 'sketchbook');?>
...
register_widget('sketchbook_social_widget');
?>
